package Practice.day11_Practice;
...
public class Practice13 {
    public static void main(String[] args) {
        ...
        // IbaseDao ib = productDao , Ibase ib = boardDao , object obj = productDto
        // long a = int b = (int)a , short c = (short)b < 다형성:다운캐스팅 >
            // (ProductDto)obj
        // 상속(오버라이딩 선택) vs 구현(오버라이딩 필수) 이용한 다형성
        // [1] 
        Soundable sound = new Cat();    sound.makeSound();
        sound = new Dog();                sound.makeSound();
        // [2] 상수는 인스턴스가 필요없다. 상수(static)이며 static은 프로그램 시작시 메모리할당 프로그램 종료시 
        // 클래스명.상수명 , 인터페이스명.상수명
        // 1. 첫글자가 대문자이면 인터페이스/클래스 명 , 2. 첫글자 소문자이면 변수/멤버변수
        // Mycar                               myCar
        // 3. 전체가 대문자이면 상수              , 4. 첫글자 소문자이면 ( )함수 또는 생성자
        // MYCAR                              myCar()
...
// [2] 인터페이스 상수(pubilc static final) 갖는다.
