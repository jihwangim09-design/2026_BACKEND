...
public class Practice2 {
    ...
    System.out.print("키를입력하세요: "); double 키 = scan.nextDouble();
    System.out.println("당신의 키는 약 " + (int)키 + "cm 이군요.");

    // 4. int+int+int/double => double , 입력개체는 클래스내 1개만 존재해도 입력함수 사용가능
    ...
    double result4 = (double)( 정수1 + 정수2 + 정수3 ) / 3.0; // 3으로 나누면 소수점 사라진다. 3.0으로 하여금 자동 double 타입변환
...
/*문제 4: Scanner를 이용해 서로 다른 3개의 정수를 입력받아, 이 값들의 합을 3.0으로 나눈 평균을 구하시오. 단, 결과는 소수점이 포함되도록 출력되어야 한다.
입력 예시:
첫 번째 정수 입력: 11
두 번째 정수 입력: 21
세 번째 정수 입력: 21
