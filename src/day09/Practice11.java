...
public class Practice11 {
    public static void main(String[] args) {
        ...
        list4.add("A"); list4.add("B"); list4.add("C"); list4.add("D"); list4.add("E ");
        list4.remove(2);
        System.out.println(list4);
        // 5.
        ArrayList<String> list5 = new ArrayList<>();
        list5.add("자바"); list5.add("파이썬"); list5.add("C++");
        list5.add(1, "자바스크립트"); // 중간삽입
        System.out.println(list5);
        // 6. 내가 만든 클래스/타입으로 제네릭타입 가능
        ArrayList <Book> bookList = new ArrayList<>();
        bookList.add( new Book("책이름1", "책저자1")); 
        bookList.add( new Book("책이름2", "책저자2"));
        bookList.add( new Book("책이름3", "책저자3"));
