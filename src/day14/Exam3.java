...
public class Exam3 {
    public static void main(String[] args) {
        // Set 인터페이스 : 여러개 자료들을 저장하는 컬렉션, 중복허용안함(자료값으로 식별) , 인덱스(순서) 없다.
        // 1. Set 구현
        ...
        // 7. .clear() : 항목 전체삭제
        set1.clear();
        // 8. .isEmpty() : 항목이 하나도 없으면 true 하나라도 있으면 false
        set1.isEmpty();
        // 9. .set 컬렉션과 반복문 관계
